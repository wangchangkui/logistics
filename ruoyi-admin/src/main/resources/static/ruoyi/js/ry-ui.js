...
(function ($) {
    $.extend({
        ...
        operate: {
            ...
            refuse: function(id) {
                table.set();
                $.modal.confirm("确定拒绝" + table.options.modalName + "请求吗？", function() {
                    var url = $.common.isEmpty(id) ? table.options.refuseUrl : table.options.refuseUrl.replace("{id}", id);
                    if(table.options.type == table_type.bootstrapTreeTable) {
                        $.operate.get(url);
                    } else {
                        var data = { "ids": id };
            ...
            agree: function(id) {
                table.set();
                $.modal.confirm("确定同意" + table.options.modalName + "请求吗？", function() {
